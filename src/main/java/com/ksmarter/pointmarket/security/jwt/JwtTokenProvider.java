...
public class JwtTokenProvider {
    ...
    public ResponseLogin.Token generateToken(Authentication authentication) {
        return generateToken(authentication.getName(), authentication.getAuthorities());
    }

    public ResponseLogin.Token generateToken(String name, Collection<? extends GrantedAuthority> inputAuthorities) {
        //권한 가져오기
