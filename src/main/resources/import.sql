...
INSERT INTO credit (account_id, balance) VALUES (1, 0);
...
INSERT INTO credit (account_id, balance) VALUES (2, 0);
...
INSERT INTO account_children (parent_id, children_id) VALUES (2, 3);
INSERT INTO credit (account_id, balance) VALUES (3, 0);
...
INSERT INTO account_children (parent_id, children_id) VALUES (2, 4);
INSERT INTO credit (account_id, balance) VALUES (4, 0);
...
INSERT INTO account_children (parent_id, children_id) VALUES (2, 5);
INSERT INTO credit (account_id, balance) VALUES (5, 0);

-- 가맹점1
INSERT INTO franchisor (franchisor_id, name, owner, business_registration_number) VALUES (1, '돌하루마트', '조동국', '1565400614');
INSERT INTO account_franchisor (account_id, franchisor_id) VALUES (1, 1);

-- 학원1
INSERT INTO institute (institute_id, name, owner, business_registration_number) VALUES (1, '태권도장', '조동국', '1565400614');
INSERT INTO account_institute (account_id, institute_id) VALUES (1, 1);
INSERT INTO institute_children (institute_id, children_id) VALUES (1, 3);
INSERT INTO institute_children (institute_id, children_id) VALUES (1, 4);
...
INSERT INTO credit (account_id, balance) VALUES (6, 0);
INSERT INTO account_institute (account_id, institute_id) VALUES (6, 1);

-- 학원2
INSERT INTO institute (institute_id, name, owner, business_registration_number) VALUES (2, 'LT미술학원', '조동국', '1565400614');
INSERT INTO account_institute (account_id, institute_id) VALUES (1, 2);
INSERT INTO institute_children (institute_id, children_id) VALUES (2, 4);
INSERT INTO institute_children (institute_id, children_id) VALUES (2, 5);


SELECT setval('account_account_id_seq', 6, true);
SELECT setval('institute_institute_id_seq', 2, true);